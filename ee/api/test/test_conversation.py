...
class TestConversation(APIBaseTest):
    ...
    def test_create_conversation(self):
        ...
        with patch(
            "ee.hogai.stream.conversation_stream.ConversationStreamManager.start_workflow_and_stream",
    ...
    def test_none_content_with_existing_conversation(self):
        ...
        with patch(
            "ee.hogai.stream.conversation_stream.ConversationStreamManager.stream_conversation",
            return_value=_async_generator(),
